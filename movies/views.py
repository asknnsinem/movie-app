...
def index(request):
    movies = data["movies"][-4:] #ensondan 4 tane liste elemanını listeler
...
def movie_details(request,slug):
    ...
    #selectedMovie= (movie for movie in movies if movie["slug"] == slug)
    #selectedMovie = next(selectedMovie)
